...
@objc public class ConnectionLayer: NSObject {
    ...
    @objc public func sendRequest(url: String, reqBody: String, reqHeaders: String, method: String, length:Int) -> CNetworkResponse {
        ...
        let headersString = headers != nil ? String(cString: headers!) : ""
        let response = CNetworkResponse(statusCode: statusCode, headers: headersString, body: UnsafePointer(bodyCCharPointer), bodyLength: bodyLength)
